				...
				<div class="row item-categories gutter-20 justify-content-center mt-4">
					@forelse ($category->subCategories as $subCategory)
						<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
							<a href="{{ route('v2.sub-category', $subCategory) }}" class="d-block h-op-09 op-ts rounded custom-shadow" style="background: url('{{ env('AWS_URL') . '/sub-category-images/' . $subCategory->cover_image ?? $fallbackImageUrl  }}') no-repeat center center; background-size: cover; height: 120px;">
