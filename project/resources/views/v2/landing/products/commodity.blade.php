...
<section id="page-title" class="page-title-pattern">
    ...
    <div class="container clearfix text-white">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('v2.category',$commodity->subCategory->category) }}">{{ $commodity->subCategory->category->name }}</a></li>
            <li class="breadcrumb-item"><a href="{{ route('v2.sub-category',$commodity->subCategory) }}">{{ $commodity->subCategory->name }}</a></li>
...
<section id="content">
                        ...
                        <div class="widget widget_links clearfix">
                            ...
                            <ul>
                                @foreach ($categories as $category)
                                    <li><a href="{{ route('v2.category', $category) }}">{{ $category->name }}</a></li>
                                @endforeach
                            </ul>
	...
	<a href="{{ route('v2.cart.add', $commodity) }}" class="cart-btn"><i
...
function updateQuantity(item, currentQuantity) {
    ...
    if (currentQuantity != newQuantity) {
        axios.post("{{ route('v2.cart.update') }}", requestBody)
            .then((response) => {
