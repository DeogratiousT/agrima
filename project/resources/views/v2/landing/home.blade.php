		...
		<div class="container z-1">
			<div class="row align-items-start justify-content-center justify-content-xl-start py-6">
				<div class="col-xl-6 col-lg-9 col-md-10 mt-xl-4 text-center text-xl-start fadeInLeft animated" data-animate="fadeInLeft">
					...
					<a href="{{ route('v2.shop') }}" class="button button-large button-white button-light h-op-09 color m-0 fw-normal color px-4">
		...
		<div class="content-wrap py-0">
			...
			<div class="section m-0">
				...
				<div class="text-center mb-5">
					...
					<a href="{{ route('v2.shop') }}" class="button button-border button-dark button-rounded button-reveal text-end text-uppercase m-0"><i class="icon-angle-right"></i><span>View All</span></a>
				</div>
				...
				<div class="row item-categories gutter-20 justify-content-center mt-4">
					@foreach ($categories as $category)
						<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
							<a href="{{ route('v2.category', $category) }}" class="d-block h-op-09 op-ts rounded custom-shadow" style="background: url('{{ env('AWS_URL') . '/category-images/' . $category->cover_image ?? $fallbackImageUrl  }}') no-repeat center center; background-size: cover; height: 240px;">
