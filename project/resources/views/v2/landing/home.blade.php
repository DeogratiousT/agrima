...
@section('content')
	...
	<section id="slider" class="slider-element dark justify-content-start">
		...
		<div class="hero-image">
			<img src="{{ asset('assets/canvas/demos/furniture/images/hero.png') }}" alt="">
		</div>
		...
		<div class="content-wrap py-0">
					...
					<div class="row justify-content-center">
						...
						<div class="col-lg-9">
							<div class="row justify-content-center align-items-center text-center mx-auto">
								<div class="col center op-05"><img src="{{ asset('assets/canvas/demos/furniture/images/sponsors/amazon.svg') }}" alt="" width="100"></div>
								<div class="col center op-05"><img src="{{ asset('assets/canvas/demos/furniture/images/sponsors/cnn.svg') }}" alt="" width="100"></div>
								<div class="col center op-05"><img src="{{ asset('assets/canvas/demos/furniture/images/sponsors/google.svg') }}" alt="" width="100"></div>
								<div class="col center op-05"><img src="{{ asset('assets/canvas/demos/furniture/images/sponsors/linkedin.svg') }}" alt="" width="100"></div>
							</div>
							<div class="row justify-content-center align-items-center mx-auto text-center mt-3">
								<div class="col center op-05"><img src="{{ asset('assets/canvas/demos/furniture/images/sponsors/netflix.svg') }}" alt="" width="100"></div>
								<div class="col center op-05"><img src="{{ asset('assets/canvas/demos/furniture/images/sponsors/jetblue.svg') }}" alt="" width="100"></div>
								<div class="col center op-05"><img src="{{ asset('assets/canvas/demos/furniture/images/sponsors/github.svg') }}" alt="" width="100"></div>
							</div>
						</div>
					</div>
			...
			<div class="container-fluid">
				...
				<div class="row item-categories gutter-20">
					<div class="col-lg-4 col-md-6">
						<a href="demo-forum-products.html" class="d-block h-op-09 op-ts" style="background: url('assets/canvas/demos/furniture/images/categories/sofas.jpg') no-repeat center center; background-size: cover; height: 340px;">
							<h5 class="text-uppercase ls1 bg-white mb-0">Sofa</h5>
						</a>
					</div>
					<div class="col-lg-4 col-md-6">
						<a href="demo-forum-products.html" class="d-block h-op-09 op-ts" style="background: url('assets/canvas/demos/furniture/images/categories/tables.jpg') no-repeat center center; background-size: cover; height: 340px;">
							<h5 class="text-uppercase ls1 bg-white mb-0">Tables</h5>
						</a>
					</div>

					<div class="col-lg-4 col-md-6">
						<a href="demo-forum-products.html" class="d-block h-op-09 op-ts" style="background: url('assets/canvas/demos/furniture/images/categories/chairs.jpg') no-repeat center center; background-size: cover; height: 340px;">
							<h5 class="text-uppercase ls1 bg-white mb-0">Chairs</h5>
						</a>
					</div>
					<div class="col-lg-4 col-md-6">
						<a href="demo-forum-products.html" class="d-block h-op-09 op-ts" style="background: url('assets/canvas/demos/furniture/images/categories/lights.jpg') no-repeat center center; background-size: cover; height: 340px;">
							<h5 class="text-uppercase ls1 bg-white mb-0">Lights</h5>
						</a>
					</div>
					<div class="col-lg-4 col-md-6">
						<a href="demo-forum-products.html" class="d-block h-op-09 op-ts" style="background: url('assets/canvas/demos/furniture/images/categories/wardrobes.jpg') no-repeat center center; background-size: cover; height: 340px;">
							<h5 class="text-uppercase ls1 bg-white mb-0">Wardrobes</h5>
						</a>
					</div>
					<div class="col-lg-4 col-md-6">
						<a href="demo-forum-products.html" class="d-block h-op-09 op-ts" style="background: url('assets/canvas/demos/furniture/images/categories/beds.jpg') no-repeat center center; background-size: cover; height: 340px;">
				...
				<div class="container">
					...
					<div id="shop" class="shop row gutter-30 col-mb-30 mt-3">
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="demo-forum-single.html"><img src="{{ asset('assets/canvas/demos/furniture/images/shop/2.jpg') }}" alt="Light Grey Sofa"></a>
									<a href="demo-forum-single.html"><img src="{{ asset('assets/canvas/demos/furniture/images/shop/2-1.jpg') }}" alt="Light Grey Sofa"></a>
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="demo-forum-single.html"><img src="{{ asset('assets/canvas/demos/furniture/images/shop/3.jpg') }}" alt="Celling Lights"></a>
									<a href="demo-forum-single.html"><img src="{{ asset('assets/canvas/demos/furniture/images/shop/3-1.jpg') }}" alt="Celling Lights"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-light me-2"><i class="icon-line-shopping-cart"></i></a>
											<a href="demos/furniture/ajax/quick-view.html" class="btn btn-light" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="demo-forum-single.html"><img src="{{ asset('assets/canvas/demos/furniture/images/shop/4-1.jpg') }}" alt="High Stand Chair"></a>
									<a href="demo-forum-single.html"><img src="{{ asset('assets/canvas/demos/furniture/images/shop/4.jpg') }}" alt="High Stand Chair"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-light me-2"><i class="icon-line-shopping-cart"></i></a>
											<a href="demos/furniture/ajax/quick-view.html" class="btn btn-light" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="demo-forum-single.html"><img src="{{ asset('assets/canvas/demos/furniture/images/shop/5.jpg') }}" alt="Dining Sofa with Tea-table"></a>
									<a href="demo-forum-single.html"><img src="{{ asset('assets/canvas/demos/furniture/images/shop/5-1.jpg') }}" alt="Dining Sofa with Tea-table"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-light me-2"><i class="icon-line-shopping-cart"></i></a>
											<a href="demos/furniture/ajax/quick-view.html" class="btn btn-light" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="demo-forum-single.html"><img src="{{ asset('assets/canvas/demos/furniture/images/shop/6.jpg') }}" alt="Bathroom Cloths Shelves"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-light me-2"><i class="icon-line-shopping-cart"></i></a>
											<a href="demos/furniture/ajax/quick-view.html" class="btn btn-light" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="demo-forum-single.html"><img src="{{ asset('assets/canvas/demos/furniture/images/shop/7.jpg') }}" alt="Golden Lamp for Room"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-light me-2"><i class="icon-line-shopping-cart"></i></a>
											<a href="demos/furniture/ajax/quick-view.html" class="btn btn-light" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="demo-forum-single.html"><img src="{{ asset('assets/canvas/demos/furniture/images/shop/8.jpg') }}" alt="White Cuddle Chair with Cusions"></a><a href="demo-forum-single.html"><img src="{{ asset('assets/canvas/demos/furniture/images/shop/8-1.jpg') }}" alt="White Cuddle Chair with Cusions"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-light me-2"><i class="icon-line-shopping-cart"></i></a>
											<a href="demos/furniture/ajax/quick-view.html" class="btn btn-light" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
			...
			<div class="container-fluid">
				...
				<div class="row align-items-lg-center col-mb-30">
					...
					<!-- Image -->
					<div class="col-xl-8 col-lg-6 px-lg-0 min-vh-50 min-vh-lg-75" style="background: url('assets/canvas/demos/furniture/images/section.jpg') no-repeat center center; background-size: cover;">
					</div>
				...
				<div class="row align-items-center no-gutters">
					...
					<div class="col-lg-4 col-md-6 order-lg-1">
						<div class="row gutter-4">
							<div class="col-6">
								<a class="d-block instagram-image" href="https://instagram.com/semicolonweb" target="_blank" style="background: url('assets/canvas/demos/furniture/images/instagram/1.jpg') no-repeat center center; background-size:cover; min-height: 33vh;"></a>
							</div>
							<div class="col-6">
								<a class="d-block instagram-image" href="https://instagram.com/semicolonweb" target="_blank" style="background: url('assets/canvas/demos/furniture/images/instagram/2.jpg') no-repeat center center; background-size:cover; min-height: 33vh;"></a>
							</div>
							<div class="col-6">
								<a class="d-block instagram-image" href="https://instagram.com/semicolonweb" target="_blank" style="background: url('assets/canvas/demos/furniture/images/instagram/3.jpg') no-repeat center center; background-size:cover; min-height: 33vh;"></a>
							</div>
							<div class="col-6">
								<a class="d-block instagram-image" href="https://instagram.com/semicolonweb" target="_blank" style="background: url('assets/canvas/demos/furniture/images/instagram/4.jpg') no-repeat center center; background-size:cover; min-height: 33vh;"></a>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 col-md-6 order-lg-3 mt-1 mt-md-0 ps-md-1 ps-lg-0">
						<div class="row gutter-4">
							<div class="col-6">
								<a class="d-block instagram-image" href="https://instagram.com/semicolonweb" target="_blank" style="background: url('assets/canvas/demos/furniture/images/instagram/5.jpg') no-repeat center center; background-size:cover; min-height: 33vh;"></a>
							</div>
							<div class="col-6">
								<a class="d-block instagram-image" href="https://instagram.com/semicolonweb" target="_blank" style="background: url('assets/canvas/demos/furniture/images/instagram/6.jpg') no-repeat center center; background-size:cover; min-height: 33vh;"></a>
							</div>
							<div class="col-6">
								<a class="d-block instagram-image" href="https://instagram.com/semicolonweb" target="_blank" style="background: url('assets/canvas/demos/furniture/images/instagram/7.jpg') no-repeat center center; background-size:cover; min-height: 33vh;"></a>
							</div>
							<div class="col-6">
								<a class="d-block instagram-image" href="https://instagram.com/semicolonweb" target="_blank" style="background: url('assets/canvas/demos/furniture/images/instagram/8.jpg') no-repeat center center; background-size:cover; min-height: 33vh;"></a>
							</div>
						</div>
					</div>
				</div>
