				...
				<div class="top-cart-items">
					...
					<div class="top-cart-item">
						<div class="top-cart-item-image border-0">
							<a href="#"><img src="{{ asset('assets/canvas/demos/furniture/images/cart/1.jpg') }}" alt="Cart Image 1" /></a>
						</div>
					...
					<div class="top-cart-item">
						<div class="top-cart-item-image border-0">
							<a href="#"><img src="{{ asset('assets/canvas/demos/furniture/images/cart/2.jpg') }}" alt="Cart Image 2" /></a>
						</div>
						<div class="top-cart-item-desc">
							<div class="top-cart-item-desc-title">
