        ...
        <div class="container">
            <div class="header-row justify-content-lg-between">
                ...
                <div id="logo" class="mx-auto col-auto flex-column order-2">
                    <a href="{{ route('home') }}" class="standard-logo"><img src="{{ asset('assets/images/logos/logo.png') }}" alt="Canvas Logo"></a>
                    <a href="{{ route('home') }}" class="retina-logo"><img src="{{ asset('assets/images/logos/logo.png') }}" alt="Canvas Logo"></a>
                </div><!-- #logo end -->
