                        ...
                        <ul>
                            ...
                            <li>
                                <div class="header-icons">
                                    @auth
                                        <a class="shopping-cart" href="{{ route('cart') }}"><i class="fas fa-shopping-cart"></i><sup class="badge badge-success" id="header-total-quantity">{{ DB::table('carts')->where('user_id', Auth::id())->first() ? DB::table('carts')->where('user_id', Auth::id())->first()->totalQuantity : 0 }}</sup></a>
