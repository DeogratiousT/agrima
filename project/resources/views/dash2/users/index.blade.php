...
@section('page-action')
    <a href="{{ route('users.create') }}" class="btn btn-primary m-4">
                        ...
                        @foreach ($users as $index => $user)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('users.edit', ['user'=>$user]) }}" class="btn icon btn-primary" data-bs-toggle="tooltip" title="Edit User">
