    ...
    <div class="card card-xxl-stretch mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">Add Commodity</span>
            </h3>
        </div>
        <!--end::Header-->
        <!--begin::Body-->
        <div class="card-body py-3">
        <form action="{{ route('dashboard.commodities.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row mb-7">
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('quantity') ? ' is-invalid' : '' }}" type="number" id="quantity" name="quantity" value="{{ old('quantity') }}" required>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('price') ? ' is-invalid' : '' }}" type="number" id="price" name="price" value="{{ old('price') }}" required>
                    @if ($errors->has('price'))
                        <span class="invalid-feedback" role="alert">
                            {{ $errors->first('price') }}
                        </span>
            ...
            <div class="form-group mb-7 mb-2">
                <button class="btn btn-primary btn-block" type="submit">Add Commodity
                </button>
            </div>
        </form>
        </div>
