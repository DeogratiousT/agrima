						...
						@foreach ($categories as $category)
							<div class="single-logo-item">
								<div class="card" style="width: 18rem;">
									<img class="card-img-top" src="https://agrimastoragefilesbucket.s3.af-south-1.amazonaws.com/category-images/{{ $category->cover_image }}" height="175rem" width="100%" alt="Category">
									<div class="card-body">
