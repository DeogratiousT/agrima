                        ...
                        <ul>
                            ...
                            <li>
                                <div class="header-icons">
                                    @auth
                                        <a class="shopping-cart" href="{{ route('cart') }}"><i class="fas fa-shopping-cart"></i><sup class="badge badge-success">{{ Redis::exists(Auth::id()) ? Redis::hget(Auth::id(), 'totalQuantity') : 0 }}</sup></a>
